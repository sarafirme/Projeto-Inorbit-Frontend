        ...
        <div className="py-10 max-w-[480px] px-5 mx-auto flex flex-col gap-6">
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                    <InOrbitIcon/>
                    <span className="text-lg font-semibold">8 a 15 de Setembro</span>
                </div>
            ...
            <div className="flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-4">
                    <h3 className="font-medium">Domingo <span className= "text-zinc-400 text-xs">(15 de Setembro)</span></h3>
                ...
                <div className="flex flex-col gap-4">
                    <h3 className="font-medium">Segunda-feira <span className= "text-zinc-400 text-xs">(09 de Setembro)</span></h3>
